...
namespace Book_Sharing.Pages
{
    ...
    public class WishListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string? titolo, string? autore, int? pagina)
        {
            ...
            var utenteLibri = _context.UtentiLibri.Where(ul => ul.fkUtente == DatiUtente.PkUtente && ul.Interesse && (ul.Titolo.ToUpper().Contains(Titolo.ToUpper()) || titolo == null) && (ul.Autore.ToUpper().Contains(Autore.ToUpper()) || autore == null)).ToList();
